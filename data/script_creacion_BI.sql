...
BEGIN
	...
	INSERT INTO [QUICK_SORT].[BI_HECHO_ENVIO](TIEMPO_ID, SUCURSAL_ID, RANGO_ETAREO_ID, LOCALIDAD_ID, CANT_ENVIOS_CUMPLIDOS,
		...
		SUM(CASE 
				WHEN DATEPART(HOUR,CAST(e.ENVIO_FECHA_ENTREGA AS TIME)) BETWEEN e.ENVIO_HORA_INICIO AND e.ENVIO_HORA_FIN   
				THEN 1 ELSE 0 END),
...
--7 PORCENTAJE DE CUMPLIMIENTO DE ENVIOS COMENTARIO
...
-- 9 TOP 5 LOCALIDADES CON MAYOR COSTO DE ENVIO
