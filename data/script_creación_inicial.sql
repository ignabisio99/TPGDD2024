...
BEGIN
	...
	INSERT INTO [QUICK_SORT].[DETALLE_TICKET](DETALLE_TICKET_TICKET_ID, PRODUCTO_ID, DETALLE_CANTIDAD,
		...
		FROM [gd_esquema].[Maestra] m
			...
			JOIN [QUICK_SORT].[PRODUCTO_SUB_CATEGORIA] sc ON sc.PRODUCTO_SUB_CATEGORIA_ID = p.PRODUCTO_SUB_CATEGORIA_ID AND sc.PRODUCTO_SUB_CATEGORIA = m.PRODUCTO_SUB_CATEGORIA
			JOIN [QUICK_SORT].[PRODUCTO_CATEGORIA] c ON c.PRODUCTO_CATEGORIA_ID = sc.PRODUCTO_CATEGORIA_ID AND m.PRODUCTO_CATEGORIA = c.PRODUCTO_CATEGORIA
