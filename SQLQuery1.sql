...
BEGIN
		...
		--TODO: Cual seria la revision? Modifique para que el detalle sea FK
...
BEGIN
	...
	INSERT INTO [QUICK_SORT].[TICKET](TICKET_SUCURSAL_ID, TICKET_EMPLEADO_LEGAJO, TICKET_CAJA_ID,TICKET_TIPO_COMPROBANTE_ID,
		...
		SELECT DISTINCT m.TICKET_NUMERO, s.SUCURSAL_ID, e.EMPLEADO_LEGAJO, c.CAJA_SUCURSAL_ID, t.TICKET_TIPO_COMPROBANTE_ID,
	...
	INSERT INTO [QUICK_SORT].[DETALLE_TICKET](DETALLE_TICKET_TICKET_ID, DETALLE_PRODUCTO_ID, DETALLE_CANTIDAD,
		...
		join [QUICK_SORT].[PRODUCTO] p ON p.PRODUCTO_NOMBRE = m.PRODUCTO_NOMBRE AND p.PRODUCTO_MARCA = m.PRODUCTO_MARCA
		WHERE m.EMPLEADO_DNI = e.EMPLEADO_DNI AND p.PRODUCTO_NOMBRE IS NOT NULL
	...
	-- REGLA_PROMOCION_PRODUCTO ¿LINKEAR POR PRODUCTO Y TICKET?
	...
	-- DETALLE_POR PROMOCION TODO: PROMO_TOTAL
