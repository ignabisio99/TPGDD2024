...
BEGIN
		...
		CREATE TABLE [QUICK_SORT].[TICKET](
			TICKET_NRO DECIMAL(18,0) IDENTITY(1,1) PRIMARY KEY,
			TICKET_SUCURSAL_ID INTEGER REFERENCES [QUICK_SORT].[SUCURSAL],
			TICKET_EMPLEADO_LEGAJO DECIMAL(18,0) REFERENCES [QUICK_SORT].[EMPLEADO],
		...
		CREATE TABLE [QUICK_SORT].[DETALLE_TICKET](
			...
			TICKET_NRO DECIMAL(18,0) REFERENCES [QUICK_SORT].[TICKET] NOT NULL,
